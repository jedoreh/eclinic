                        ...
                        <nav class="navbar navbar-expand-lg navbar-light" style="text-align:left">
                            ...
                            <div class="navbar-collapse align-items-center"
                                ...
                                <ul class="navbar-nav align-items-center">
                                    <li class="nav-item">
                                        <a class="nav-link" href="patient-registration.html">Patient Card Registration</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="admin-patient-card-update.html">Patient Card Update</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="admin-patient-record-list.html">Patient Record List</a>
                                    </li>
